...
const botname = global.botname || '🌸 KARINA UWU-𝐀𝐈 🌸'
const creador = 'gabxz 𝘅𝘇𝘅𝘀𝘆 ⚡'
const version = '4.3.1 Versión Oficial'
const web = 'https://xzys-ultra.verce.app'  
...
let taguser = '@' + m.sender.split('@')[0]
    ...
    const botType = isOfficialBot ? '🎀 𝗕𝗼𝘁 𝗢𝗳𝗶𝗰𝗶𝗮𝗹:  KARINA BOT 𝗢𝗳𝗶𝗰𝗶𝗮𝗹 🌟' : '🌱 𝗦𝘂𝗯-𝗕𝗼𝘁: 𝗡𝗼 𝗕𝗼𝘁 𝗢𝗳𝗰𝗶𝗮𝗹 🌟'
